...
<tr>
    ...
    <td class="text-center" width="8%">
        <a href="{{ url('admin/products_group/'.$product_group->id.'/edit') }}" data-toggle="tooltip" title="{{ trans('adminlte::adminlte.product_group.edit') }}"><i class="fa fa-edit"></i></a>&nbsp;
        <a href="{{ route('product_group.delete', $product_group->id) }}" data-toggle="tooltip" title="{{ trans('adminlte::adminlte.product_group.delete') }}" class="delete-item"><i class="fa fa-trash"></i></a>
    </td>
</tr>
@endforeach
