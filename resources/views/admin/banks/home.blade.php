	...
	<div class="content">
		<div class="row">
            ...
            <div class="box-header">
              <div class="col-md-6"><h3 class="box-title">{{ trans('adminlte::adminlte.banks') }}</h3></div>
              <div class="col-md-6">

                <form class="form-inline text-center pull-right" method="GET" action="{{ URL::to('/admin/banks') }}">
                  @include('includes.search_filter')
                  <a href="{{ url('admin/banks/create') }}" data-toggle="tooltip" class="btn btn-success pull-right" style="margin-left: 0.5em;" title="{{ trans('adminlte::adminlte.banks_details.create_new') }}"><i class="fa fa-plus"></i> {{ trans('adminlte::adminlte.new') }}</a>
                  <a data-toggle="tooltip" class="btn btn-danger" id="delsel" title="{{ trans('adminlte::adminlte.banks_details.delete_all') }}"><i class="fa fa-trash"></i> {{ trans('adminlte::adminlte.delete') }}</a>
                </form>
            ...
            <div class="box-body table-div">
              <table id="example2 orders" class="table table-bordered table-hover text-center">
                ...
                <tr>
                    ...
                    <th class="sorting" data-sorting_type="asc" data-column_name="bank_number">{{ trans('adminlte::adminlte.bank_number') }} <span id="bank_number_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
                ...
                <tbody>
                  @include('admin.banks.table_data')
                </tbody>
              </table>
