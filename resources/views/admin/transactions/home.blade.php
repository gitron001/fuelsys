  ...
  <div class="box-body">
    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
      <form class="form-inline text-center" method="GET" action="{{ URL::to('/admin/transactions') }}">
        ...
        <div class="form-group">
            <input type="checkbox" name="last_payment"  id="last_payment" {{ request()->get("last_payment") == 'Yes' ? 'checked' : ''}}> {{ trans('adminlte::adminlte.transactions_details.from_last_payment') }}<br>
        </div>&nbsp;

        <div class="form-group">
          <input type="checkbox" name="inc_transactions"  id="inc_transactions" {{ request()->get("inc_transactions") == 'Yes' ? 'checked' : ''}}> {{ trans('adminlte::adminlte.transactions_details.inc_transactions') }}<br>
        </div>&nbsp;

        <div class="form-group">
            <input type="checkbox" name="exc_balance"  id="exc_balance" {{ request()->get("exc_balance") ? 'checked' : ''}}> {{ trans('adminlte::adminlte.transactions_details.exc_balance') }}<br>
        </div>&nbsp;

        <div class="form-group">
            <input type="checkbox" name="all_day"  id="all_day" {{ request()->get("all_day") == 'Yes' ? 'checked' : ''}}> {{ trans('adminlte::adminlte.transactions_details.all_day') }}<br>
        </div>&nbsp;
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover text-center">
            <thead>
              <tr>
                <th class="sorting" data-sorting_type="asc" data-column_name="user_id">{{ trans('adminlte::adminlte.user') }} <span id="user_id_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
                ...
                <th class="sorting" data-sorting_type="asc" data-column_name="#">{{ trans('adminlte::adminlte.transactions_details.bonus_driver_card') }} <span id="#" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="product_id">{{ trans('adminlte::adminlte.product') }} <span id="product_id_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
                ...
                <th class="sorting" data-sorting_type="asc" data-column_name="lit">{{ trans('adminlte::adminlte.lit') }} <span id="lit_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
                <th class="sorting" data-sorting_type="asc" data-column_name="money">{{ trans('adminlte::adminlte.total') }} <span id="money_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
