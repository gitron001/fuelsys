...
@section('content')
	<h1>{{ !isset($transaction) ? 'Create new transaction' : 'Edit transaction' }}</h1>
		...
		<div class="form-group">
			{!! Form::submit((!isset($transaction) ? 'Create new transaction' : 'Edit transaction'), ['class'=>'btn btn-block btn-success']); !!}
		</div>
