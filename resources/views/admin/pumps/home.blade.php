            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover text-center">
                ...
                <tr>
        			...
        			<th class="sorting" data-sorting_type="asc" data-column_name="status">Starting Totalizer <span id="status_icon" class="removePrevIcon sortIcon"><span class="glyphicon glyphicon glyphicon glyphicon-sort"></span></span></th>
